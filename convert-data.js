...
const headers = Object.keys(jsonData.ProductCollection[0]).join(',');
const rows = jsonData.ProductCollection.map(product => 
...
fs.writeFileSync('db/data/com.products.manager.cap-Products.csv', csv);